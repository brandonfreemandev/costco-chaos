  ...
  return (
    ...
    >
      <mesh castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#8a8580" roughness={0.92} metalness={0.05} />
      </mesh>
    </RigidBody>
  );
}
  ...
  return (
    <group>
      <mesh castShadow receiveShadow position={[0, centerY, centerZ]}>
        ...
        <meshStandardMaterial color="#9a9590" roughness={0.88} metalness={0.08} />
      </mesh>

      <mesh position={[0, height - 0.8, frontZ + 0.35]}>
        <boxGeometry args={[width - 2, 1.4, 0.4]} />
        <meshStandardMaterial color="#005daa" roughness={0.55} />
      </mesh>
      <mesh position={[0, height - 0.8, frontZ + 0.7]}>
        <boxGeometry args={[width - 6, 0.55, 0.15]} />
        <meshStandardMaterial color="#e31837" roughness={0.5} />
      </mesh>
      ...
      <mesh position={[0, 0.12, frontZ + 2.5]} rotation={[-Math.PI / 2, 0, 0]}>
